			...
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="post" action="inserirUsuario.php" name="logon">
					...
					<div class="form-group">
						...
						<input name="nome_user" type="text" class="form-control" required id="nome_user">
					</div>
				
				<div class="form-group">
				
						<label for="sobrenome_user">Sobrenome</label>
						<input name="sobrenome_user" type="text" class="form-control" required id="sobrenome_user">
				</div>
